...
ActiveRecord::Schema.define(version: 20_211_106_175_618) do
  # These are extensions that must be enabled in order to support this database
  enable_extension 'plpgsql'

  create_table 'que_jobs', primary_key: %w[queue priority run_at job_id], comment: '3', force: :cascade do |t|
    ...
    t.index ['job_class'], name: 'que_scheduler_job_in_que_jobs_unique_index', unique: true,
                           where: "(job_class = 'Que::Scheduler::SchedulerJob'::text)"
  end

  create_table 'que_scheduler_audit', primary_key: 'scheduler_job_id', id: :bigint, default: nil, comment: '6',
                                      force: :cascade do |t|
  ...
  add_foreign_key 'que_scheduler_audit_enqueued', 'que_scheduler_audit', column: 'scheduler_job_id',
                                                                         primary_key: 'scheduler_job_id', name: 'que_scheduler_audit_enqueued_scheduler_job_id_fkey'
